...
if ! id nftfw-web >/dev/null 2>&1; then useradd --system --home-dir /var/empty --shell /usr/sbin/nologin nftfw-web; fi
install -d -o root -g nftfw -m 0750 "$CONF_DIR" "$STATE_DIR"
