    ...
    <section class="details">
      <div class="detail-group">
        ...
        <dl>
          ...
          <div><dt>Configuration mode</dt><dd id="managed-mode">-</dd></div>
          <div><dt>Public exposure</dt><dd id="public-exposure">-</dd></div>
          <div><dt>LAN access</dt><dd id="lan-access">-</dd></div>
