...
| Coverage | PASS | Overall 76.6%; setup 90.0%; import 90.6%; intent 92.6%; routing 90.5%; adoption 91.1% |
...
| Privileged R2 | FAIL, HARD STOPPED | The latest approved run passed preceding disposable package/database/network/chaos gates, then the bundled Docker lifecycle exposed legacy static provenance incompatibility. A renewed run is NOT EXECUTED and requires new identity-bound approval |
