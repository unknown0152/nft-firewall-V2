...
| Coverage | PASS | Overall 76.5%; setup 90.0%; import 90.6%; intent 92.6%; routing 90.5%; adoption 91.1% |
...
| Privileged R2 | FAIL, HARD STOPPED | The latest approved run exposed the clean-host missing-table behavior before setup mutation; source review also found non-clean Docker classification was not enforced. A renewed run is NOT EXECUTED and requires new identity-bound approval |
